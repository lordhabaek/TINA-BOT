...
const ownerNumber = ['263712473551']

//===================SESSION-AUTH============================
if (!fs.existsSync(__dirname + '/sessions/creds.json')) {
if(!config.SESSION_ID) return console.log('Please add your session to SESSION_ID env !!')
const sessdata = config.SESSION_ID.replace("TINA-BOT~", '');
...
console.log("CONNECTING TINA-BOT 🧬...");
...
console.log('TINA-BOT CONNECTED TO WHATSAPP ENJOY ✅')

let up = `*╭──────────────●●►*
> *➺ TINA-BOT ᴄᴏɴɴᴇᴄᴛᴇᴅ sᴜᴄᴄᴇssғᴜʟʏ ᴛʏᴘᴇ .ᴍᴇɴᴜ ᴛᴏ ᴄᴏᴍᴍᴀɴᴅ ʟɪsᴛ ᴄʀᴇᴀᴛᴇᴅ ʙʏ LORD HABAEK ✅*

> *❁ᴊᴏɪɴ ᴏᴜʀ ᴡʜᴀᴛsᴀᴘᴘ ᴄʜᴀɴɴᴇʟ ғᴏʀ ᴜᴘᴅᴀᴛᴇs 

*https://whatsapp.com/channel/0029Vb53vVVG3R3rgaQSVs2o*

*YOUR IS BOT ACTIVE NOW ENJOY♥️🪄*\n\n*PREFIX: ${prefix}*
...
if(senderNumber.includes("263712473551")){
if(isReact) return
m.react("🦋")
   }
